...
#   @D1-J04
#   Scenario: Agent hooks are installed after init with claude agent
#     Given I run CleanStart for flow "agent-hooks-claude"
#     And   I start the daemon in bitloops
#     And   I run InitCommit for bitloops
#     And   I run bitloops init --agent claude in bitloops
#     Then  git hooks exist for the claude agent in bitloops
...
#     And   I run InitCommit for bitloops
#     And   I run bitloops init --agent claude in bitloops
#     And   I run bitloops init --agent claude --force in bitloops
#     Then  git hooks exist for the claude agent in bitloops
