...
use super::types::{
    ARCHITECTURE_GRAPH_CAPABILITY_ID, ARCHITECTURE_GRAPH_FACT_SYNTHESIS_SLOT,
    ARCHITECTURE_GRAPH_ROLE_ADJUDICATION_SLOT,
};

const ARCHITECTURE_GRAPH_INFERENCE_SLOTS: &[InferenceSlotDescriptor] = &[
    InferenceSlotDescriptor {
        name: ARCHITECTURE_GRAPH_FACT_SYNTHESIS_SLOT,
        task: crate::config::InferenceTask::StructuredGeneration,
    },
    InferenceSlotDescriptor {
        name: ARCHITECTURE_GRAPH_ROLE_ADJUDICATION_SLOT,
        task: crate::config::InferenceTask::StructuredGeneration,
    },
];
