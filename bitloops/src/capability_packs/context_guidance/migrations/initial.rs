...
use super::super::storage::context_guidance_sqlite_schema_sql;

fn run_context_guidance_initial_schema(ctx: &mut dyn CapabilityMigrationContext) -> Result<()> {
    ctx.apply_devql_sqlite_ddl(context_guidance_sqlite_schema_sql())
}

pub static CONTEXT_GUIDANCE_MIGRATIONS: &[CapabilityMigration] = &[CapabilityMigration {
