...
use crate::host::devql::{
    DevqlConfig, resolve_repo_identity, run_capability_packs_report, run_query,
};
...
pub use args::{
    DevqlArgs, DevqlCommand, DevqlConnectionStatusArgs, DevqlIngestArgs, DevqlInitArgs,
    DevqlKnowledgeAddArgs, DevqlKnowledgeArgs, DevqlKnowledgeAssociateArgs, DevqlKnowledgeCommand,
    DevqlKnowledgeRefArgs, DevqlPacksArgs, DevqlQueryArgs,
};
