...
pub(crate) use execution::{
    ...
    execute_prepared_bitloops_inference_setup_with_progress, prepare_cloud_bitloops_inference_plan,
...
#[cfg(test)]
pub(crate) use profiles::with_bitloops_inference_generation_configured_hook;
#[cfg(test)]
...
pub(crate) use profiles::{
    bitloops_inference_generation_configured, context_guidance_generation_configured,
...
pub(crate) use types::{
    BitloopsInferenceSetupSelection, ContextGuidanceSetupSelection, PreparedSummarySetupAction,
