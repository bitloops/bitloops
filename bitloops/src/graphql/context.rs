...
use crate::host::checkpoints::strategy::manual_commit::{
    list_committed, read_committed_info, run_git,
};
...
use super::types::{
    Branch, Checkpoint, Commit, DateTimeScalar, HealthBackendStatus, HealthStatus, Repository,
};
...
fn git_default_branch_name(repo_root: &Path) -> String {
...
fn read_commit_checkpoint_mappings_all(repo_root: &Path) -> Result<BTreeMap<String, Vec<String>>> {
...
fn is_missing_sqlite_store_error(err: &anyhow::Error) -> bool {
