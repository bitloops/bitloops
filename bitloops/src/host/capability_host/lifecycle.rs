...
pub fn run_migrations<M: CapabilityMigrationContext + KnowledgeMigrationContext>(
...
mod tests {
    ...
    use crate::capability_packs::knowledge::storage::{
        DuckdbKnowledgeDocumentStore, KnowledgeDocumentRepository, KnowledgeRelationalRepository,
    ...
    use crate::host::capability_host::runtime_contexts::LocalStoreHealthGateway;
    ...
    impl IngesterHandler for NoopIngesterHandler {
        fn ingest<'a>(
            &'a self,
            _request: crate::host::capability_host::registrar::IngestRequest,
            _ctx: &'a mut dyn CapabilityIngestContext,
        ) -> BoxFuture<'a, Result<crate::host::capability_host::registrar::IngestResult>> {
            Box::pin(async move {
                Ok(crate::host::capability_host::registrar::IngestResult::new(
                    json!({}),
                    "",
                ))
            })
