...
pub(crate) async fn build_relational_artefacts_query(
    ...
    let sql = format!(
        "SELECT a.symbol_id, a.artefact_id, a.path, a.canonical_kind, a.language_kind, a.language, a.parent_artefact_id, a.start_line, a.end_line, a.start_byte, a.end_byte, a.signature, a.modifiers, a.docstring, a.blob_sha, a.symbol_fqn, a.content_hash, {} \
FROM {} a \
WHERE {} \
