...
const SEMANTIC_ARCHITECTURE_EMBEDDING_MAILBOX_NAME: &str = "semantic_clones.embedding.architecture";
...

            {
                ...
                for row in rows {
                    ...
                    let mailbox_name = match representation_kind.as_str() {
                        ...
                        "architecture" => SEMANTIC_ARCHITECTURE_EMBEDDING_MAILBOX_NAME,
