...
fn hook_commands(local_dev: bool) -> [(&'static str, String); 9] {
    ...
    [
        (
            ...
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_SESSION_START
            ),
        ),
        (
            HOOK_TYPE_SESSION_END,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_SESSION_END
            ),
        ),
        (
            HOOK_TYPE_BEFORE_SUBMIT_PROMPT,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_BEFORE_SUBMIT_PROMPT
            ),
        ),
        (
            HOOK_TYPE_BEFORE_SHELL_EXECUTION,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_BEFORE_SHELL_EXECUTION
            ),
        ),
        (
            HOOK_TYPE_AFTER_SHELL_EXECUTION,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_AFTER_SHELL_EXECUTION
            ),
        ),
        (
            HOOK_TYPE_STOP,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_STOP
            ),
        ),
        (
            HOOK_TYPE_PRE_COMPACT,
            format!(
                "{prefix}{}",
                crate::engine::agent::cursor::lifecycle::HOOK_NAME_PRE_COMPACT
            ),
        ),
        (
            HOOK_TYPE_SUBAGENT_START,
