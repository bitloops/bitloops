...
use crate::engine::extensions::capability::CapabilityPackRegistrationStatus;
use crate::engine::extensions::language::LanguagePackRegistrationStatus;
...
mod tests {
    use super::*;
    use crate::engine::extensions::CoreExtensionHost;
