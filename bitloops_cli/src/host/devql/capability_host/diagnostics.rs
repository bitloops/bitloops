...
/// DevQL capability host plus optional [`CoreExtensionHostRegistryReport`](crate::host::extensions::CoreExtensionHostRegistryReport) (same CLI).
#[derive(Debug, Clone, Serialize)]
pub struct PackLifecycleReport {
    pub devql_capability_host: HostRegistryReport,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub core_extension_host: Option<crate::host::extensions::CoreExtensionHostRegistryReport>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub fn format_pack_lifecycle_report_human(report: &PackLifecycleReport) -> String {
    ...
    if let Some(ext) = report.core_extension_host.as_ref() {
        s.push_str("\n---\n");
        s.push_str(&crate::host::extensions::format_core_extension_host_registry_human(ext));
