...
use crate::host::extensions::capability::CapabilityPackRegistrationStatus;
use crate::host::extensions::language::LanguagePackRegistrationStatus;
...
mod tests {
    use super::*;
    use crate::host::extensions::CoreExtensionHost;
    ...
    fn builtin_extension_registry_lists_language_and_capability_packs() {
        ...
        assert_eq!(r.language_packs.len(), 2);
