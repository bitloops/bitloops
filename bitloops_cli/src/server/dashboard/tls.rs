...
fn eprint_mkcert_not_found_on_path() {
    eprintln!();
    eprintln!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    eprintln!("  Dashboard HTTPS — mkcert not found (browser will not be opened)");
    eprintln!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    eprintln!();
    ...
    INIT.get_or_init(|| {
        if CryptoProvider::get_default().is_none() {
            rustls::crypto::aws_lc_rs::default_provider()
                .install_default()
                .expect("install rustls aws_lc_rs crypto provider");
        }
    });
    Ok(())
}
...
fn mkcert_identity_args(browser_host: &str) -> Vec<String> {
    match browser_host {
        ...
        "::1" => vec!["::1".into(), "localhost".into(), "127.0.0.1".into(), "::1".into()],
        other => {
            vec![
                other.to_string(),
                "localhost".into(),
